...
public class ReportsController : ControllerBase
{
    ...
    private static List<string> BuildIndividualValueConflicts(Dictionary<ValueCategory, double> categoryProfile)
    {
        ...
        {
            conflicts.Add("You value both autonomy and structure, which can create tension between freedom and predictability.");
        }
        ...
        {
            conflicts.Add("You prioritize both strong results and harmonious relationships, which may feel conflicting in tough decisions.");
        }
        ...
        {
            conflicts.Add("You are drawn to both innovation and stability, so change initiatives may feel energizing and stressful at the same time.");
        }

        if (!conflicts.Any())
        {
            conflicts.Add("No major internal value tension is visible right now.");
        }
